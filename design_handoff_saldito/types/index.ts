...
export type TipoNotificacion =
  | 'gastoNuevo' | 'pagadorAsignado' | 'gastoEditado' | 'gastoAnulado'
  | 'pagoDeclarado' | 'pagoConfirmado' | 'recurrentePendiente'
  | 'planIniciado' | 'movimientoMarcado' | 'planCancelado' | 'planCompletado'
  | 'recordatorio' | 'grupo';
...
export type Pantalla =
  | 'inicio' | 'gastos' | 'gastoDetalle' | 'nuevoGasto' | 'editarGasto'
  | 'confirmarBorrador' | 'deudas' | 'grupo'
  | 'perfil' | 'notificaciones' | 'categorias';
